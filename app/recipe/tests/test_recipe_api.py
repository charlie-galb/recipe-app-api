...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Fish sauce')
...
class RecipeImageUploadtests(TestCase):
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test returning recipes by ingredients"""
        recipe1 = sample_recipe(user=self.user, title='Posh beans on toast')
        recipe2 = sample_recipe(user=self.user, title='Chick cacciatore')
        ingredient1 = sample_ingredient(user=self.user, name='Feta cheese')
        ingredient2 = sample_ingredient(user=self.user, name='Chicken')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Beef ragu')
